...
<body>
    ...
    <div class="container-fluid position-relative p-0 w-100">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid px-2 px-md-4">
                <a href="login.php">
                <img src="img/logo.jpg" alt="logo aprodej" style="width: 55px; height: auto; border-radius: 10px;"></a>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1 w-100">
    ...
    <!-- Facts Start -->
    <div class="container-fluid facts py-0 pt-lg-0 w-100">
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white mb-0">Dons délivrés</h5>
                            <h1 class="text-white mb-0" data-toggle="counter-up">56345</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-12">
            <div class="row g-5">
                <div class="">
                    ...
                    <h2><b>L'ONG se fixe comme objectifs</b> <br></h2>
                    <p style="text-align: justify; color: black;">    
                        ...
                        Favoriser l'implication des couches vulnérables (notamment les femmes) dans le processus de développement socio-économique des communautés;<br>
                        Promouvoir l'intégration des femmes et des jeunes dans les activités socioéconomiques et politiques ;  
                    </p>
                    <div class="position-relative h-100">
                        <h3 class="">Promotion des droits humains</h3>
                        <p style="text-align: justify;">La lutte contre les violences basées sur le genre (VBG) à travers le renforcement des capacités des acteurs communautaires et la création d'un environnement protecteur pour l'émancipation des filles/femmes ;
                            Renforcement des capacités des structures des protections et les leaders communautaires sur les conventions, les textes des lois interdisant les pratiques néfastes des VBG ;<br>
                            Mise en place d'un mécanisme de prise en charge des victimes des VBG, la gestion des cas, le référencement et le plaidoyer ;
                        </p>
                    </div>
                </div>             
            </div>
    ...
    <div class="col-12 container">
        ...
        <!-- Projet UNICEF MGF -->
        <h1 class="fw-bold text-primary text-uppercase text-center">PROJET MGF</h1>
        <h2 class="mb-0 text-center">Contribuer à l'abandon des pratiques de Mutilations Génitales Féminines (MGF) dans les régions de Conakry, Kindia et Boké</h2>
        <br>
        <div class="row col-12" style="text-align: justify;">
            <div class="">
                ...
                <h5 style="text-align: justify;"><b>Zone de couverture :</b> Région de Boké, Préfectures de : Boffa, Boké, Fria, Gaoual et Koundara.</h5>
                ...
                <img src="img/unicefIMG.png" style="border-radius: 5px;" alt="" width="100%">
            </div>
        </div>
        <br>
